...
package com.ycengine.ontimealarm.dialogs;
...
public class RingtonePickerDialog extends BaseAlertDialogFragment {
    ...
    public static RingtonePickerDialog newInstance(OnRingtoneSelectedListener l, Uri ringtoneUri, int volume) {
        RingtonePickerDialog dialog = new RingtonePickerDialog();
        dialog.mOnRingtoneSelectedListener = l;
        dialog.mRingtoneUri = ringtoneUri;
        dialog.mVolume = volume;
        return dialog;
    }
        ...
        builder.setTitle(R.string.sound)
                .setSingleChoiceItems(cursor, checkedItem, labelColumn, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        mRingtone = new RingtoneOnce(getActivity(), mRingtoneUri);
                        if (mVolume > 0) {
                            mRingtone.setmVolume(mVolume);
                        }
                        mRingtone.play();
                    }
                });
