package com.ycengine.rainsound.library.wheel;
...
import com.ycengine.rainsound.library.wheel.adapters.WheelViewAdapter;
...
public class HorizontalWheelView extends WheelView {
	...
	protected int calculateLayoutHeight(int heightSize, int mode) {
	    ...
	    itemsLayout.measure(View.MeasureSpec.makeMeasureSpec(heightSize, View.MeasureSpec.UNSPECIFIED),
        ...
        itemsLayout.measure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.EXACTLY, height - 2 * PADDING), View.MeasureSpec.makeMeasureSpec(0, View.MeasureSpec.UNSPECIFIED));
