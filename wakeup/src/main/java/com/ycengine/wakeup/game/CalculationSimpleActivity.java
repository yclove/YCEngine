...
public class CalculationSimpleActivity extends BaseActivity implements View.OnClickListener, IOnHandlerMessage {
    ...
    private int mIdx;
    private TextView mNotifyName, mQuestion, mAnswer;
    ...
    private void generateCalculation() {
        ...
        int calculationSt = generator.nextInt(2);
        int calculationNd = generator.nextInt(2);
        ...
        while (!isPossibleCalculation) {
            ...
            if (calculationLimit > 100) {
                ...
                if (calculationSt != calculationNd) {
                    ...
                    calculationNd = generator.nextInt(2);
                }
            }
        }
